...
db.serialize(() => {
  ...
  db.run("CREATE TABLE users (name TEXT, id TEXT, list TABLE)");
  db.run("CREATE TABLE restaurants (id, TEXT, name TEXT, address TEXT, img TEXT)");
  db.run("CREATE TABLE tags (id TEXT, name TEXT)");
